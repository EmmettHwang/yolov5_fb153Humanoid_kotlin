...
| 버전 | 날짜 | 상태 | 주요 변경 내용 |
|------|------|------|--------------|
| **0.9.250520** | 2025-05-20 | ✅ 최신 | BT 기기 인식 오류 수정 (FB153 v1.0.0 인식), 메인 화면 우선 진입, 헤더 BT 버튼 개선, 전체 기기 보기 추가 |
...
| `FB153 v1.0.0` 기기 인식 안됨 | ✅ | 필터 대소문자·공백 무시 (toLowerCase + replaceAll) |
| 앱 시작 시 BT 연결 강제 대기 | ✅ | 스플래시 → 결과 무관하게 메인 화면 직행, BT는 헤더에서 선택 |
